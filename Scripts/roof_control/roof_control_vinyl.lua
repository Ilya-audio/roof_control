-- @description Roof|control: VINYL (Mode Switch)
-- @version 0.95
-- @author Ilya
-- @link https://github.com/Ilya-audio/roof_control
-- @about
--    Part of the Roof|control headphone monitoring system.
--    This script switches the monitoring mode to "Vinyl" emulation via gmem.

local this_mode = 5 -- Индекс для Vinyl
...
-- 4. Мгновенная синхронизация интерфейса
...
-- Сигнал Бубрику не вмешиваться в отрисовку
reaper.gmem_write(4, 1) 

-- Мгновенное обновление тулбара
SyncToolbarNow()
